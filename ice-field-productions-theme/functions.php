...
function ifp_assets(){$ifp_theme_version=wp_get_theme()->get('Version');wp_enqueue_style('ifp-style',get_stylesheet_uri(),array(),$ifp_theme_version);wp_enqueue_script('ifp-script',get_template_directory_uri().'/assets/theme.js',array(),$ifp_theme_version,true);}add_action('wp_enqueue_scripts','ifp_assets');
