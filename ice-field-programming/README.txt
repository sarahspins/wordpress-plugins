...
Version 1.9.1.16 allows active Dash rows with an unmapped source Sport to be selected and resolved by the administrator's Bulk classification Sport choice. Programming provides a clear validation message when that required choice is missing.
